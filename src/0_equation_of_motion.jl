...
# ╔═╡ 05090ed0-8a16-4592-b0c9-ac8ea66688ef
using Symbolics

# ╔═╡ 428100e0-27b1-11ef-2e17-87fd12b8856f
md"""
...
ここで $X$ の微分を $X$ と $f$ で表現する必要があります．これの計算はそれなりに面倒なので，Julia の `Symbolics` パッケージを使用して計算します．
"""

# ╔═╡ 01e1ee87-d346-4e26-b06b-80d90db7ec4d
begin
	# 変数を宣言する
...
# ╔═╡ 73b38f81-a242-4e29-8709-28114d050f26
begin
    # x の２階微分を消去する
...
# ╔═╡ ce46b8fd-6085-4860-be92-f04ad6e65c71
begin
    # θ の２階微分を消去する
...
manifest_format = "2.0"
project_hash = "765bde3f8ba0200cc7b974080da07604c81b6335"
